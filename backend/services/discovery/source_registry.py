...
class SourceRegistry:
    ...
    def __init__(self, *, openai_api_key: str = "", openai_model: str = "") -> None:
        ...
        self._modes: dict[str, set[str]] = {
            ...
            "ai": {"Greenhouse", "Lever", "Ashby", "GitHubDiscovery", "AI Discovery", "Remotive"},
            "fortune500": {"Greenhouse", "Lever", "Workable", "RemoteOK", "TheMuse", "AI Discovery"},
            ...
            "visa": {"Greenhouse", "Lever", "RemoteOK", "TheMuse", "Wellfound", "AI Discovery"},
        }
